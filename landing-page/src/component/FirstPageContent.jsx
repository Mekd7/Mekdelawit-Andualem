...
export default function FirstPageContent(){
    return(
        <>
        <h1 className='font-[poppins] text-center font-bold text-5xl pt-20 pb-2' >The Future of Manufacturing <br/>with <span className='text-green-900'>Latest Technology</span> </h1>
     ...
     <div className='buttons flex justify-center gap-10 pt-5'>
      <button className='bg-green-900 rounded border py-2 px-6 rounded-3xl text-white font-semibold'>Get Started</button>
      <button className='rounded border py-2 px-6 rounded-3xl text-green-900 font-semibold'> Try Demo</button>
     </div>
     <div className='flex justify-center py-20 gap-8 '>
        ...
        <section className='rounded-3xl bg-green-900 text-white shadow-lg text-center h-48 w-50 mt-23 pt-8'>
        ...
        <section className='bg-green-100 rounded-3xl shadow-lg h-48 w-50 text-center mt-23 pt-8'>
            <p><span className='text-3xl font-bold ' >6+</span> <br/> Years of <br/> Dedicated <br/> Service</p>
        </section>

        <section className=' w-50 text-white py-3 px-4 font-semibold bg-green-900 rounded-3xl shadow-lg'>
